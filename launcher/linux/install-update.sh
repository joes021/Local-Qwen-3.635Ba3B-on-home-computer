...
TARGET_PATH="$TARGET_DIR/Local-Qwen-Setup-latest.run"
mkdir -p "$TARGET_DIR"

echo "Preuzimam latest installer u: $TARGET_PATH"
curl -L "https://github.com/joes021/Local-Qwen-3.635Ba3B-on-home-computer/releases/latest/download/Local-Qwen-Setup-latest.run" -o "$TARGET_PATH"
chmod +x "$TARGET_PATH"
